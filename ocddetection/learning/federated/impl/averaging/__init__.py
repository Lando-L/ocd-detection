...
from ocddetection.learning.federated.impl.averaging import client, process, server
...
def __client_state_fn(idx: int, pos_weight: float) -> client.State:
	return client.State(
...
def setup(
	...
	return __client_state_fn, iterator, validator, evaluator
