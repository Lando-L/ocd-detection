...
from ocddetection.learning.federated.impl.averaging import client, server


MODEL_FN = Callable[[], tff.learning.Model]
OPTIMIZER_FN = Callable[[], tf.keras.optimizers.Optimizer]
CLIENT_STATE_FN = Callable[[], client.State]
CLIENT_UPDATE_FN = Callable[[tf.data.Dataset, client.State, server.Message, tff.learning.Model, tf.keras.optimizers.Optimizer], client.Output]
