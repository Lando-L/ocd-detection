...
from ocddetection.learning.federated.stateful.impl.layers import client, server, utils
...
def __initialize_optimizer(
    ...
    model_delta = tf.nest.map_structure(tf.zeros_like, model.base_model.trainable_variables)
